...
def ErrorHandler():
    ...
    print("ErrCalibration = "+str(ErrCalibration.get()))
...
def MoveProbe(Input):
    ...
    Input is string, either "Up", "Down", or "Stop", moving the probe up or 
    down '''
    if Input == "Up":
        LowerPin.low()
        RaisePin.high()
